...
public class HomePanel extends JLayeredPane {
    ...
    /**
     * Creates a new document panel with DocumentButtons for each document in the list.
     *
     * @return JPanel containing DocumentButtons for each document.
     */
    ...
    /*
    * [MainPanel]
    * Main Panel that is responsible for all non scrolling elements
     */
    private class MainPanel extends JPanel {
         ...
         * Also includes interactible elements for file upload
         */
        MainPanel() {
            ...
            publishButton.addActionListener(e -> {
                // Exception cases that can't make a proper file
    ...
    /**
     * sort
     * This method sorts documents based on the provided sortType parameter.
     * @param sortType A String specifying the type of sorting to be applied
     */
    ...
    /**
     * search
     * Filters/Searches documents based on a given text
     * @param documents An ArrayList of Document objects to be searched
     * @param value The text to be searched for
     * @return ArrayList<Document> A new ArrayList containing documents that match the search criteria
     */
    ...
    /**
     * getDocumentsCopy
     * returns the copied document arraylist
     * @return copired document arraylist
     */
    public ArrayList<Document> getDocumentsCopy() {
